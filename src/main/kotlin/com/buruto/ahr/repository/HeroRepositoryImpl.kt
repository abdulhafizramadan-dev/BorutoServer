...
private const val PREV_PAGE_KEY = "prevKey"
private const val NEXT_PAGE_KEY = "nextKey"
...
class HeroRepositoryImpl : HeroRepository {
    ...
    override suspend fun getAllHeroes(page: Int): ApiResponse {
        val calculatedPage = calculatePage(page)
        return ApiResponse(
            success = true,
            message = "Success get heroes",
            prevPage = calculatedPage[PREV_PAGE_KEY],
            nextPage = calculatedPage[NEXT_PAGE_KEY],
            data = heroes[page] ?: emptyList()
        )
    }
